...
### DATASET
# dataset:https://www.kaggle.com/moradnejad/200k-short-texts-for-humor-detection
...
config.output_attentions = False # Set to True to obtain hidden states
config.use_cache = False # Set to True to obtain hidden states
